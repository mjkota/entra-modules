...
#>
  ...
  Foreach ($LocationDisplayName in $LocationDisplayNames) {
    If (($LocationDisplayName.ToString() -ne "All") -and ($LocationDisplayName.ToString() -ne "AllTrusted")) {
    ...
    Elseif ($LocationDisplayName.ToString() -eq "AllTrusted") {
      $LocationGuids = $null
      $LocationGuids += "AllTrusted"
    }
    Else {
      $LocationGuids = $null
      $LocationGuids += "All"
